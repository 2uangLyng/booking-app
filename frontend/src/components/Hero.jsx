  ...
  return (
    <section className='max-padd-container bg-hero bg-center bg-cover bg-no-repeat h-[722px] w-full'>
      <div className='relative top-32 xs:top-48'>
        ...
        <p className='my-5 max-w-[33rem] text-black'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Non rerum dolorum cumque magni rem illo quia, autem porro excepturi.
        </p>
        {/* Button */}
        <div className='inline-flex items-center justify-center gap-4 bg-white rounded ring-1 ring-slate-900/5 mt-4'>
          <div className='regular-14 text-center leading-tight pl-5 cursor-default'>
            <p className='regular-14 text-black'><span className='uppercase'>10% off</span> On All Properties</p>
          </div>
          ...
          <div className='flex relative'>
            ...
            <img src={client1} alt="" className='h-[46px] border-2 border-white shadow-sm rounded-full'/>
             ...
             <img src={client2} alt="" className='h-[46px] border-2 border-white shadow-sm rounded-full absolute left-32'/>
              ...
              <div className='h-[46px] border-2 border-white w-[46px] shadow-sm bg-slate-500/70 text-white absolute left-48 rounded-full flexCenter text-xs font-semibold'>210k+</div>
          </div>
