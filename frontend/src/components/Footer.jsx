...
const Footer = () => {
  return (
    <footer>
      <div className="max-padd-container flex items-start justify-between flex-col lg:flex-row gap-8 py-2 mb-7 bg-gradient-to-r from-[#edf1c9] via-white to-white">
        <div>
        ...
        <div className="flexStart flex-wrap gap-8">
          <div className="flexCenter gap-x-6">
            ...
            <div>
              ...
              <p className="text-black">123, Avenue, Cl</p>
            </div>
          </div>
          <div className="flexCenter gap-x-6">
            <FaPhone />
            <div>
              ...
              <p className="text-black">+0123456789</p>
            </div>
          </div>
          <div className="flexCenter gap-x-6">
            <FaMailBulk />
            <div>
              ...
              <p className="text-black">info@zenhomes.com</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* copyrights */}
      <p className="max-padd-container medium-14 py-2 px-8 rounded flexBetween mt-6 bg-gradient-to-r from-[#edf1c9] via-white to-white">
        <span className="text-gray-600">2025 ZenHomes</span>
